...
use Qt::QtWidgets::RQAction:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQObject:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;



class QAction:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>
    is QObject
    does RQAction
    is export {
