...
use Qt::QtWidgets::QCoreApplication:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQGuiApplication:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;



class QGuiApplication:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>
    is QCoreApplication
