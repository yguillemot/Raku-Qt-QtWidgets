...
use Qt::QtWidgets::QImage:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QLabel:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QPaintDevice:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QPen:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;
...
class QPainter:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>
    is QtBase
    is export {
