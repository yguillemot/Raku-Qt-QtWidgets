...
use Qt::QtWidgets::QImage:ver<0.0.6>:auth<zef:yguillemot>:api<2>;
use Qt::QtWidgets::QLabel:ver<0.0.6>:auth<zef:yguillemot>:api<2>;
...
class QPainter:ver<0.0.6>:auth<zef:yguillemot>:api<2>
    is QtObject
    does RQPainter
    is export {
