...
use Qt::QtWidgets::QFont:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
...
use Qt::QtWidgets::QRegion:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
...
class QWidget:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>
    is QObject
    is QPaintDevice
    does RQWidget
    is export {
