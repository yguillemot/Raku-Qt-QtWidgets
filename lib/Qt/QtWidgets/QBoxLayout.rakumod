...
use Qt::QtWidgets::QLayout:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQBoxLayout:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQLayout:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;



class QBoxLayout:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>
    is QLayout
    does RQBoxLayout
    is export {
