...
use Qt::QtWidgets::QDialog:ver<0.0.6>:auth<zef:yguillemot>:api<2>;
use Qt::QtWidgets::QWidget:ver<0.0.6>:auth<zef:yguillemot>:api<2>;
use Qt::QtWidgets::QtBase:ver<0.0.6>:auth<zef:yguillemot>:api<2>;
use Qt::QtWidgets::RQMessageBox:ver<0.0.6>:auth<zef:yguillemot>:api<2>;



class QMessageBox:ver<0.0.6>:auth<zef:yguillemot>:api<2>
    is QDialog
    is QtObject
    does RQMessageBox
    is export {
