...
use Qt::QtWidgets::QAbstractButton:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QtBase:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQMenu:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQPushButton:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQWidget:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;



class QPushButton:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>
    is QAbstractButton
    does RQPushButton
    is export {
