...
use Qt::QtWidgets::QBoxLayout:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QtBase:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQVBoxLayout:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>;



class QVBoxLayout:ver<0.0.2>:auth<cpan:YGUILLEMO>:api<2>
    is QBoxLayout
    does RQVBoxLayout
    is export {
