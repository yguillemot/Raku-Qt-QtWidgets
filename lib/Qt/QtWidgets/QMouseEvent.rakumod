...
use Qt::QtWidgets::QInputEvent:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QPointF:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::Qt:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::QtBase:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>;



class QMouseEvent:ver<0.0.3>:auth<cpan:YGUILLEMO>:api<2>
    is QInputEvent
    is export {
