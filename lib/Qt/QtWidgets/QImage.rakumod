...
use Qt::QtWidgets::QColor:ver<0.0.6>:auth<zef:yguillemot>:api<2>;
...
use Qt::QtWidgets::RQImage:ver<0.0.6>:auth<zef:yguillemot>:api<2>;



class QImage:ver<0.0.6>:auth<zef:yguillemot>:api<2>
    is QPaintDevice
    is QtObject
    does RQImage
    is export {
