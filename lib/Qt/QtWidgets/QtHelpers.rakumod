...
unit module QtHelpers:ver<0.0.7>:auth<zef:yguillemot>:api<2>;
...
# That's why these hashes are initialized here.
    ...
    %signals<QDialog>.push(SigSlot.new(
        name => "finished",
        sig => "(Int)",
        qSig => "(int)",
        signature => :(Int),
    ...
    %signals<QDialogButtonBox>.push(SigSlot.new(
        name => "clicked",
        sig => "(QAbstractButton)",
        qSig => "(QAbstractButton*)",
        signature => :(RQAbstractButton),
        sigIsSimple => True,
        isPlainQt => True,
        isSlot => False,
        isPrivate => False
