...
use Qt::QtWidgets::QDialog:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQWidget:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;
use Qt::QtWidgets::RQFileDialog:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>;



class QFileDialog:ver<0.0.4>:auth<cpan:YGUILLEMO>:api<2>
    is QDialog
    does RQFileDialog
    is export {
