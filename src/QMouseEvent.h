...
EXTERNC void * SCWQMouseEventCtor_1(int  type, void * localPos, int  button, int  buttons, int  modifiers);
EXTERNC void * QWQMouseEventCtor_2(int  type, void * localPos, void * screenPos, int  button, int  buttons, int  modifiers);
EXTERNC void * SCWQMouseEventCtor_2(int  type, void * localPos, void * screenPos, int  button, int  buttons, int  modifiers);
...
EXTERNC void * SCWQMouseEventCtor_3(int  type, void * localPos, void * windowPos, void * screenPos, int  button, int  buttons, int  modifiers);
...
EXTERNC void * SCWQMouseEventCtor_4(int  type, void * localPos, void * windowPos, void * screenPos, int  button, int  buttons, int  modifiers, int  source);
EXTERNC int32_t QWQMouseEventx(void * obj);
EXTERNC int32_t QWQMouseEventy(void * obj);
EXTERNC int QWQMouseEventbutton(void * obj);
EXTERNC void QWvalidateCB_QMouseEvent(void *obj, int32_t objId, char *methodName);
EXTERNC void QWQMouseEventDtor(void *);
EXTERNC void SCWQMouseEventDtor(void *);
