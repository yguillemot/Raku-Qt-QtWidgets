...
void * SCWQPainterCtor_1()
{
    SCQPainter * ptr = new SCQPainter();
    return reinterpret_cast<void *>(ptr);
}
...
void QWQPaintersetFont(void * obj, void * f)
{
    QPainter * ptr = reinterpret_cast<QPainter *>(obj);
    QFont & xf = * reinterpret_cast<QFont *>(f);
    ptr->setFont(xf);
}
...
void QWQPainterdrawRect_3(void * obj, void * rect)
{
    QPainter * ptr = reinterpret_cast<QPainter *>(obj);
...
void QWQPainterdrawText_3(void * obj, int32_t  x, int32_t  y, char * s)
{
    QPainter * ptr = reinterpret_cast<QPainter *>(obj);
    int xx = x;
    int xy = y;
    QString xs = QString(s);
    ptr->drawText(xx, xy, xs);
}

void QWQPainterdrawText_6(void * obj, void * r, int32_t  flags, char * text, void * br)
{
    QPainter * ptr = reinterpret_cast<QPainter *>(obj);
    QRect & xr = * reinterpret_cast<QRect *>(r);
    int xflags = flags;
    QString xtext = QString(text);
    QRect * xbr = reinterpret_cast<QRect *>(br);
    ptr->drawText(xr, xflags, xtext, xbr);
}

void * QWQPainterboundingRect_2(void * obj, void * rect, int32_t  flags, char * text)
{
    QPainter * ptr = reinterpret_cast<QPainter *>(obj);
    QRect & xrect = * reinterpret_cast<QRect *>(rect);
    int xflags = flags;
    QString xtext = QString(text);
    QRect retVal = ptr->boundingRect(xrect, xflags, xtext);
    QRect * xxretVal = new QRect(retVal);
    void * xretVal = reinterpret_cast<void *>(xxretVal);
    return xretVal;
}

void * QWQPainterboundingRect_3(void * obj, int32_t  x, int32_t  y, int32_t  w, int32_t  h, int32_t  flags, char * text)
{
    QPainter * ptr = reinterpret_cast<QPainter *>(obj);
    int xx = x;
    int xy = y;
    ...
    int xflags = flags;
    QString xtext = QString(text);
    QRect retVal = ptr->boundingRect(xx, xy, xw, xh, xflags, xtext);
    QRect * xxretVal = new QRect(retVal);
    void * xretVal = reinterpret_cast<void *>(xxretVal);
    return xretVal;
}

void QWvalidateCB_QPainter(void *obj, int32_t objId, char *methodName)
{
    SCQPainter * ptr = reinterpret_cast<SCQPainter *>(obj);
