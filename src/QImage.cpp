...
void * SCWQImageCtor_3(int32_t  width, int32_t  height, int  format)
{
    int xwidth = width;
    int xheight = height;
    QImage::Format xformat = static_cast<QImage::Format>(format);
    SCQImage * ptr = new SCQImage(xwidth, xheight, xformat);
    return reinterpret_cast<void *>(ptr);
}
...
void QWvalidateCB_QImage(void *obj, int32_t objId, char *methodName)
{
    SCQImage * ptr = reinterpret_cast<SCQImage *>(obj);
