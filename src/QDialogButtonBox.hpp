...
class SCQDialogButtonBox : public QDialogButtonBox, public CallbackValidator
{
public:
    SCQDialogButtonBox(QWidget* parent):
        QDialogButtonBox(parent)
    { }

    SCQDialogButtonBox(Qt::Orientation orientation, QWidget* parent):
        QDialogButtonBox(orientation, parent)
    { }

    SCQDialogButtonBox(StandardButtons buttons, QWidget* parent):
        QDialogButtonBox(buttons, parent)
    { }

    SCQDialogButtonBox(StandardButtons buttons, Qt::Orientation orientation, QWidget* parent):
