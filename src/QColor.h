...
EXTERNC void * SCWQColorCtor_2(int  color);
EXTERNC void * QWQColorCtor_3(int32_t  r, int32_t  g, int32_t  b, int32_t  a);
EXTERNC void * SCWQColorCtor_3(int32_t  r, int32_t  g, int32_t  b, int32_t  a);
...
EXTERNC void QWvalidateCB_QColor(void *obj, int32_t objId, char *methodName);
EXTERNC void QWQColorDtor(void *);
EXTERNC void SCWQColorDtor(void *);
