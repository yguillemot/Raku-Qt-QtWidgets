...
void * SCWQPointFCtor_1()
{
    SCQPointF * ptr = new SCQPointF();
    return reinterpret_cast<void *>(ptr);
}
...
void * SCWQPointFCtor_2(void * p)
{
    QPoint & xp = * reinterpret_cast<QPoint *>(p);
    SCQPointF * ptr = new SCQPointF(xp);
    return reinterpret_cast<void *>(ptr);
}
...
void * SCWQPointFCtor_3(double  xpos, double  ypos)
{
    qreal xxpos = xpos;
    qreal xypos = ypos;
    SCQPointF * ptr = new SCQPointF(xxpos, xypos);
    return reinterpret_cast<void *>(ptr);
}
...
void QWvalidateCB_QPointF(void *obj, int32_t objId, char *methodName)
{
    SCQPointF * ptr = reinterpret_cast<SCQPointF *>(obj);
